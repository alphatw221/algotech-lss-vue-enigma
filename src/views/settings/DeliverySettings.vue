        ...
        <div class="px-5 lg:p-10  intro-y grid grid-cols-12 gap-1 lg:gap-5 -z-50">
            ...
            <div v-for="(option, index) in deliverySettings.additional_delivery_options" class="col-span-12" :key="index">
                <div class="grid grid-cols-12 gap-3 mt-3">
                    ...
                    />
                    <button 
                        class="btn btn-danger inline-block text-base w-full mx-5 col-span-11 lg:col-span-3 lg:w-24" 
            ...
            <a 
                class="col-end-10 w-fit inline-block text-base my-3 col-span-2"
                @click="addDelivery()"
            >
               <u> + Add more option  </u> 
            </a>
