	...
	<div class="p-5 my-5 intro-y">
		...
		>
			...
			<template v-slot:save >
				<button class="btn btn-primary w-fit float-right mt-2" @click="updateGeneralSettings()" :disabled="generalSettingsUpdating">
		...
		>
			...
			<template v-slot:save >
				<button class="btn btn-primary w-fit float-right mt-2" @click="updatePaymentSettings()" :disabled="paymentSettingsUpdating">
		...
		>
			...
			<template v-slot:save >
				<button class="btn btn-primary w-fit float-right mt-2" @click="updateLogisticSettings()" :disabled="logisticSettingsUpdating">
