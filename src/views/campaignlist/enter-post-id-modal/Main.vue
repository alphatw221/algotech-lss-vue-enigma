<template>
    ...
    >
      ...
      <ModalBody class="grid grid-cols-12 gap-4 gap-y-3">
        <div class="items-end col-span-12" style="display: inline-flex">
          
        </div>
        <div class="col-span-12 mr-5 sm:col-span-4">
          <div class="items-end h-10" style="display: inline-flex">
            <label for="modal-form-1" class="mr-5 text-lg font-medium"
              >Facebook</label
            >
            <div
          ...
          <button
            ...
            class="w-full mt-3 mr-3 btn btn-primary sm:w-40"
          >
            Select Page
          </button>
          <div>
      ...
      <ModalFooter>
        ...
        <button type="button" class="w-20 btn btn-primary" @click="enterLive()" 
