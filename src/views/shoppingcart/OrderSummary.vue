  ...
  <div class="box p-5 m-3 border-2 border-secondary">
    <div>
      ...
      <div class="flex">
        ...
        <div class="font-medium">{{store.order.campaign.currency}} {{ parseFloat(store.order.subtotal).toFixed(2) }}</div>
      </div>
      <div class="flex mt-4">
        ...
        <div class="font-medium text-danger">{{store.order.campaign.currency}} {{ parseFloat(store.order.adjust_price).toFixed(2) }}</div>
      </div>
      ...
      <div v-if="store.shipping_info.shipping_method !== 'pickup'"
        ...
        <div class="font-medium">{{store.order.campaign.currency}} {{ shippingCost }}</div>
      </div>
