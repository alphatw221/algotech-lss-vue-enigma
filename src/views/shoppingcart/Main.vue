<template>
  <div class="flex flex-wrap">
    ...
    <!-- Tab List-->
      ...
      <div
        class="box relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg"
      >
          ...
          <div class="tab-content tab-space">
            <div v-bind:class="{ hidden: openTab !== 1, block: openTab === 1 }">
              ...
              <div class="box grid grid-cols-12 gap-4">
                ...
                <div
                  class="col-span-12 2xl:col-start-8 2xl:col-span-5 lg:col-start-8 lg:col-span-5"
                >
