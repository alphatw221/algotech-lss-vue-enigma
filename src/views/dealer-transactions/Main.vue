<template>
  <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">Tabulator</h2>
      <button @click="addProduct()" class="btn btn-primary shadow-md mr-2 mt-4 sm:mt-0">Add New Product</button>
  </div>
...
const initTabulator = () => {
  tabulator.value = new Tabulator('#tabulator', {
    ajaxURL: "http://127.0.0.1:8000/api/v2/order/buyer/history/",
    ajaxConfig:{
        method:"GET",
        headers:{
