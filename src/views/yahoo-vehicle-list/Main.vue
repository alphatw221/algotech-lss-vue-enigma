...
import { search_yahoo_vehicles } from '../../api_carlet/carlet.js'
const route = useRoute()
const router = useRouter()

const title = 'Yahoo車輛資料庫'
...
const searchBarSettings=[
    ...
    {key:'displacement', name:'排氣量', type:'input', placeholder:'輸入排氣量', action:'search'},
    {key:'output', name:'輸出', type:'input', placeholder:'輸出hp', action:'search'},
...
const dataListSettings=[
    ...
    {key:'displacement', name:'排氣量', type:'text', dataType:'integer', headerClass:'text-center', class:'text-center', sortable:true},
    {key:'output', name:'輸出', type:'text', dataType:'integer', headerClass:'text-center', class:'text-center', sortable:true},
