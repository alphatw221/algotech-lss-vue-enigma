...
import { search_tire_rack_vehicles } from '../../api_carlet/tire_rack.js'
const route = useRoute()
const router = useRouter()

const title = 'TireRack車輛資料庫'
...
const dataListSettings=[
    ...
    {key:'year', name:'生產年份', type:'text', dataType:'integer', headerClass:'text-center', class:'text-center', sortable:true},
