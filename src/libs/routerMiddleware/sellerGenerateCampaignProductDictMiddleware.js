...
export default async (to, from) => {
    ...
    if(parseInt(to.params.campaign_id) != campaignDetailStore.campaignProductCampaignID){
        ...
        if (res.status==200) {
            ...
            campaignDetailStore.campaignProductCampaignID = parseInt(to.params.campaign_id) 
        }
    }
